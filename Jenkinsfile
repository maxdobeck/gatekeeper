  ...
  stages {
    stage('Build') {
      steps {
        ...
        sh 'ls /go/src/github.com/maxdobeck/gatekeeper &&  /go/src/github.com/maxdobeck/gatekeeper/git checkout create-jenkinsfile && /go/src/github.com/maxdobeck/gatekeeper/git pull'
